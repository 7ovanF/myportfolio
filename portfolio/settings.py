...
# Boolean. Decides from .env whether or not code is production ready.
...
if PRODUCTION:
    ...
    SECRET_KEY = 'idk, i think this goes in .env'
...
CSRF_TRUSTED_ORIGINS = ["http://localhost", "http://127.0.0.1", "https://jovan-finesta-myportfolio.pws.cs.ui.ac.id"]
...
# Settings for Django-Markdownify
